    ...
    while True:
        ...
        try:
            ...
            if linkareer_site.text!="" and target_date >= one_month_ago and target_date <= current_date: ## 1달내로 올린 글이고, folder가 비지않았으면 계속 탐색
                ...
                header=driver3.find_element(By.CSS_SELECTOR,'#__next > div.jss2.PageLayout__StyledWrapper-sc-8e20e380-0.hyrgHR > div.internal-nav-bar.InternalNavBar__StyledWrapper-sc-3b9fd182-0.jxFbnW > div > div.menu-list > button:nth-child(3) > div.second-depth-nav > div > div > div > button:nth-child(3)')
                ...
                if header.get_attribute("data-active")=="true":
                    ...
                    detail_content=driver3.find_element(By.CSS_SELECTOR,'#__next > div.jss2.PageLayout__StyledWrapper-sc-8e20e380-0.hyrgHR > div.MuiContainer-root.jss10.jss1.MuiContainer-maxWidthLg > div > div.jss3 > div.jss4.jss5 > div:nth-child(4) > div:nth-child(1) > div.jss147')
                    ...
                    print("대외활동에 대한 정보가 아닙니다 재탐색 합니다.")
